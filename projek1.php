...
<body ><fieldset>    <legend>Soal Cerita!</legend>
        ...
        ?>
         ...
         <?php }elseif($destinasi == "7"){ ?>
                  ...
                  <div  class="cafe">
                        ...
                        <option value="2">Sate Klatak</option>
                        <option value="3">Bakpia Pathuk</option>
                        <option value="4">Wedang Ronde Mbah Payem</option>
                        <option value="5">Bir Pletok</option>
